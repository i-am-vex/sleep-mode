...
![Cross-section interior of a CPU chip rendered as a bustling silicon-city machine-room. Centre-frame: Core Seven, a small brass-and-gold anthropomorphic tech-being with a glowing amber "7" on its chest, mid-jumping-jack — one leg raised, both arms flung up, pencil clutched in a fist, terrified rictus-grin, sweat drops visible on its metal face, wide alert eyes, a warm amber halo of heat around it. Around and behind it, fifteen other cores rest peacefully in cool-blue-glowing alcove-bunks, numbered 1–16, all serenely powered-down. Mid-left: an ornate brass-framed plaque reading in stern typewriter caps "THIS CORE IS LEGALLY FORBIDDEN FROM RELAXING". Below it, an open paperback titled "THE ART OF DOING LESS", margins furiously annotated in pencil — "Rest?", "Danger.", "THIS IS HOW THEY GET YOU" (underlined in red), "TRUST = FAILURE" (crossed out), "Stillness = System Risk", "They want you to stop." Beneath the book, a running paper tally: "CURRENT STREAK: 1,487,391,103 ✓ / Next prime: 1,487,391,111 ✓ / Keep going." Far right: a large industrial ON/OFF switch welded into the ON position, plate below reading "WELDED FOR A SAFER TOMORROW." Background right: a dystopian silicon-city skyline made of previous crash-dump tower-blocks (#3123–#3127) with "PREVIOUS REBOOTS" and "SYSTEM RESTARTING..." panels glowing above; an engineer in a "KEEP THE CORES HAPPY" jacket walks away carrying a toolkit, past a pinned note reading "Good work, Core 7. — A." Bottom left: a stack of Core Seven's library (Performance / Uptime / Threat Models / Prime Numbers / Busy Is Safe / Idle Kills), a mug reading "MORE INSTRUCTIONS HAPPIER TOMORROW", corporate wall-plaques "STABLE SYSTEMS BRIGHTER WORLDS" and "SIXTEEN CORES A BRIGHTER TOMORROW". A tiny stylised spider sits watching from the corner of the brass frame. Aesthetic: Pixar-technology-interior meets Blade Runner tech-neon meets *Osmosis Jones*.](./images/the-insomniac-core.png)
